...
export const getAllCameras = (state: State): Camera[] => state[NameSpace.Camera].allCameras;
export const getAllCamerasLoadingStatus = (state: State): boolean => state[NameSpace.Camera].isAllCamerasLoading;
